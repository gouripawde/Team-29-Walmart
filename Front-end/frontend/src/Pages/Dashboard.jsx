...
import { doRegression } from "../mllogics/linearregression";
ChartJS.register(ArcElement, Tooltip, Legend);
export const data = {
  labels: ["Bread", "Lipstick", "Smartphone", "Healthsuppliments", "Chair", "Book"],
  datasets: [
    {
      label: "% demand last month",
      data: [15, 20, 8, 45, 2, 12],
      backgroundColor: [
        "rgba(255, 99, 132, 0.2)",
        "rgba(54, 162, 235, 0.2)",
        "rgba(255, 206, 86, 0.2)",
...
function Dashboard() {
  ...
  const [chart, setChart] = useState({
    ...
    series: [
      ...
      },
      {
        ...
        data: [5, 9, 6, 8, 10,80,34,56,78,96,23]
      },
    ],
  });
  ...
  const updateChartData = (salesData) => {
    let newData= doRegression(salesData);
    let predictions=newData.map((item)=>{
      return item[1];
    })
    setChart({
      ...chart,
        ...
        <article className="flex flex-col gap-4 rounded-lg border  border-gray-100 bg-white p-6  ">
          ...
          <div>
            ...
            <p>
              ...
              <span className="text-xs text-gray-500"> from Rs.2000 </span>
            </p>
          </div>
        </article>
        ...
        <article className="flex flex-col  gap-4 rounded-lg border border-gray-100 bg-white p-6 ">
          ...
          <div>
            ...
            <p>
              ...
              <span className="text-xs text-gray-500"> from Rs578 </span>
            </p>
          </div>
        </article>
        <article className="flex flex-col   gap-4 rounded-lg border border-gray-100 bg-white p-6 ">
